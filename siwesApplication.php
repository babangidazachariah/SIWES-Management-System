...
SESSION_START();
	if(isset($_POST['btnSubmitButton']))
	{
		...
		if(empty($_POST['cboApplicationType']))
		{
			$isError = true;
		}
		...
		if (!($isError))
		{
			...
			$sql = "SELECT * FROM tblApplications WHERE applicationNumber='". $_POST['txtNumber'] ."'";
			$result = mysqli_query($con, $sql) or die(mysqli_error($con));
			
			if(mysqli_num_rows($result) < 1)
			{
				
				$sql = "INSERT INTO tblApplications (applicationType,
														applicationNumber,
														applicationName,
														applicationEmail,
														...
														VALUES ('".$_POST['cboApplicationType']."', 
														'". $_POST['txtNumber'] ."',
														'". $_POST['txtName'] ."',
														'". $_POST['txtEmail'] ."',
														'". $_POST['txtOffice'] ."',														
				...
				mysqli_query($con, $sql) or die(mysqli_error($con));
				 if($_POST['cboApplication'] == 1) {
					 $appType ="an Industry "; 
				}else{
					$appType ="an Institution ";
				}
				
				$headers = "From: itfsiwes@gmail.com \r\n MIME-Version: 1.0 \r\n Content-type:text/html;charset=UTF-8 \r\n";
				if(mail($_POST['txtEmail'], "IFT SIWES System Application Notification", "Dear Sir/Ma, \nThank for expressing your interest in contributing your quota towards making Nigeria great for our future leaders. This mail is to notify you on the reception of your request to join SIWES Scheme as ". $appType . ". Our dedicated team are now working on your application and would respond as soon as the verification of the submitted detais is completed. \n\nThank you and once again and welcome. \n\n\nSincerely, \nOur ITF Team.", $headers))
				{
				 
					$errorMessage = "Successfully Added. Email Notification has also been sent to your mail";
				}else{
					
					$sql = "DELETE FROM tblApplications WHERE applicationEmail ='". $_POST['txtEmail'] ."'";
					mysqli_query($con, $sql) or die(mysqli_error($con));
					
					 $errorMessage = "There Was Problem Receiving Your Request. Try Again!!!";
...
<script type='text/Javascript'>
	...
	function ValidateSubmission()
	{
		...
		if(Selectedvalue == '') {
			...
			errorMessage = "Select Select Either Institution or Industry!!!";
		}else if((document.getElementById('txtNumber').value == '') ) {
			
			errorMessage = "Type Establishement Number!!!";
		}else if((document.getElementById('txtName').value == '') ) {
			errorMessage = "Type Establishement Name!!!";
		}else if((document.getElementById('txtEmail').value == '') ) {
			errorMessage = "Type Working Email ID!!!";
		}else if((document.getElementById('txtOffice').value == '') ) {
			errorMessage = "Type Head Office Address!!!";
		}
    ...
    <div id="apDiv36">
      ...
      <div id="apDiv63">
		...
		<div class='shortContainer'>
				...
				<h1 class="title">SIWES Application</h1>
			<form id="siwesApplication" name="siwesApplication" class="form" onsubmit="return ValidateSubmission();" action="siwesApplication.php" method="POST">
				<label id='error' class='error'><?php print($errorMessage); ?></label>
				<select id="soflow"  name='cboApplicationType' tabindex="1">
				...
				<input type="text" placeholder="Registration Number Here" id="txtNumber" name="txtNumber" tabindex="2"/>
			
				<input type="text" placeholder="Name Here" id="txtName" name="txtName" tabindex="3"/>
				<input type="text" placeholder="Email Here" id="txtEmail" name="txtEmail" tabindex="4"/>
				<input type="text" placeholder="Head Office Address Here" id="txtOffice" name="txtOffice" tabindex="5"/>
      ...
      <div id="apDiv65"  style="border:1px #666666 solid;">
		...
		<label for='name'><a href='siwesHome.php'><div class='menuButton'> Sign In</div></a></label>
		<p>&nbsp;</p>
		
		<div class='container'>
			<h1 class="title">Application Guide</h1>
			<img src='images/leftArrow.png' width='20px' height='15px' />Please Fill the Form by the left.
			<br />The submitted information shall be  confirmed before approval is made. Therefore, provide us with accurate Head Office Address.
			<br />The E-mail should be a working mail accessible by Head of SIWES in your Establishment. You shall receive our response through the submitted Email ID.
		 </div>
		 </div>
	  </div>
