...
<script type='text/Javascript'>
	...
	function ValidateSubmission()
	{
		...
		if(Selectedvalue == '') {
			...
			errorMessage = "Select Select Either Institution or Industry!!!";
		}elseif((document.getElementById('txtNumber').value == '') ) {
  ...
  <div id="mainContent">
    ...
    <div id="apDiv36">
      ...
      <div id="apDiv63">
		...
		<div class='shortContainer'>
			<h1 class="title">SIWES Application</h1>
			<form id="application" name="application" class="form" onsubmit="return ValidateSubmission();" action="application.php" method="POST">
				<label id='error' class='error'><?php print($errorMessage); ?></label>
				<select id="soflow"  name='cboApplicationType' tabindex="1">
				  <!-- This method is nice because it doesn't require extra div tags, but it also doesn't retain the style across all browsers. -->
				  <option value=''>Select Application Type</option>
