<?php
SESSION_START();
	if((!empty($_SESSION['schoolStaffID'])) && (strcmp($_SESSION['schoolStaffRole'],"Admin") == 0) || (strcmp($_SESSION['schoolStaffRole'],"Staff") == 0))
	{
		...
		if(isset($_POST['btnSubmitButton']))
		{
			...
			if (!($isError))
			{
				...
				$sql = "UDATE tblSchoolStaff SET schoolIdentificationNumber='".$_POST['txtStaffNumber']."',".
												"schoolStaffFirstName='".$_POST['txtFirstName']."',".
												"schoolStaffLastName='".$_POST['txtLastName']."',".
												"schoolStaffMiddleName='".$_POST['txtMiddleName']."'".
				"WHERE schoolIdentificationNumber='". $_SESSION['schoolID']."', AND schoolStaffRegistrationNumber='".$_SESSION['schoolStaffID']."' OR schoolStaffEmail='". $_SESSION['schoolStaffID'] ."'";
...
<script type='text/Javascript'>
	...
	function ValidateSubmission()
	{
		...
		if((Selectedvalue == '') ) {
			...
			errorMessage = "Select Admin/Staff Role!!!";
		}else if((email == '') ) {
			errorMessage = "Type Admin/Staff Email!!!";
		}
		...
		if(errorMessage != ""){
			...
			//validate the so called mail is actually an email
    ...
    <div id="apDiv36">
      ...
      <div id="apDiv63">
		...
		<div class='container'>
			...
			<form id="form" class="form" action="updatePersonalInfo.php" onsubmit="return ValidateSubmission();" method="POST">
				...
				<?php
					...
					$sql = "SELECT * FROM tblSchoolStaff WHERE schoolIdentificationNumber='". $_SESSION['schoolID']."', AND schoolStaffRegistrationNumber='".$_SESSION['schoolStaffID']."' OR schoolStaffEmail='". $_SESSION['schoolStaffID'] ."'";
					...
					if(mysqli_num_rows($result) > 0)
					{
						...
						{
							$staffNumber = $row['schoolStaffRegistrationNumber'];
							$firstName = $row['schoolStaffFirstName'];
							$middleName = $row['schoolStaffMiddleName'];
							$lastName = $row['schoolStaffLastName'];
				...
				<table border='1' width='100%' align='left'>
					<tr>
						<td width='40%'>Staff ID : </td><td><input value='<?php print($staffNumber); ?>' type="text" placeholder="Staff Identification Number Here" id="txtStaffNumber" name="txtStaffNumber" tabindex="1"/></td>
					</tr>
					<tr>
						<td width='40%'>First Name : </td><td><input value='<?php print($firstName); ?>'  type="text" placeholder="Staff First Name Here" id="txtFirstName" name="txtFirstName" tabindex="2"/></td>
					</tr>
					<tr>
						<td width='40%'>Middle Name : </td><td><input value='<?php print($middleName); ?>'  type="text" placeholder="Staff Middle Name Here" id="txtMiddleName" name="txtMiddleName" tabindex="3"/></td>
					</tr>
					<tr>
						<td width='40%'>Last Name : </td><td><input  value='<?php print($lastName); ?>' type="text" placeholder="Staff Last Name Here" id="txtLastName" name="txtLastName" tabindex="4"/></td>
					</tr>
					<tr>
      ...
      <div id="apDiv65"  style="border:1px #666666 solid;">
		...
		<div class='container'>
			<?php
				...
				if(strcmp($_SESSION['schoolStaffRole'],"Staff") == 0)
				{
			
					print(
					
						"<div class='title'>Staff Dashboard</div>
						<div class='subTitle'>Welcome ". $_SESSION['schoolStaffFirstName'] . " ".$_SESSION['schoolStaffLastName']."</div>
						<a href='../changePassword.php'><div class='menuButton'>Change Password</div></a>
						<a href='updatePersonalInfo.php'><div class='menuButton'>Update Personal Information</div></a>
						<a href='viewCurrentStudents.php'><div class='menuButton'>View Current SIWES Students</div></a>
						<a href='viewCompletedStudents.php'><div class='menuButton'>View Completed SIWES Students</div></a>
						
						<a href='../siwesHome.php?action=logout'><div class='menuButton'>Logout</div></a>"
					);
				}elseif(strcmp($_SESSION['schoolStaffRole'],"Admin") == 0)
				{
			
					print(
					
						"<div class='title'>Admin. Dashboard</div>
						<div class='subTitle'>Welcome ". $_SESSION['schoolStaffName'] ."</div>
						<a href='../changePassword.php'><div class='menuButton'>Change Password</div></a>
						<a href='updatePersonalInfo.php'><div class='menuButton'>Update Personal Information</div></a>
