	...
	{	
		if(isset($_POST['btnSubmitButton'])){
			...
			if(!empty($_FILES['uploadfile'])){
				...
				$dir = $_SERVER['DOCUMENT_ROOT']."siwes/ActivityGallery";
				...
				$query = "INSERT INTO tblDailyActivity (studentMatricNumber,
												activityDate,
												activityDescription, 
												activityComment
												) VALUES ('" . $_SESSION['matricNumber']. "','" . $_POST['cboDate'] . "','" . $_POST['txtActivity'] . "','" . $_POST['txtComment'] ."')";
				...
				$imagename = $imageDate. $_SESSION['matricNumber'] . $last_id . $ext;
				// update the image table now that the final filename is known.
				$query = "UPDATE tblDailyActivity SET activitySnapshot = '" . $imagename . "'	WHERE activityID = " . $last_id;
				$result = mysqli_query($con, $query) or die (mysqli_error($con));
    ...
    <div id="apDiv36">
		...
		<div class='shortContainer'>
			...
			<form id="form" class="form" method="POST" onsubmit="return ValidateSubmission();" action="siwesDailyReport.php" enctype="multipart/form-data">
				<label id='error' class='error'><?php print($errorMessage); ?></label>
					...
					<!--<b id="progress_bar"><font class="percent" color="red" name="Arial" size="4"><b></b></font></b>-->
				...
				<select id="soflow"  name='cboDate' tabindex="1">
				  <!-- This method is nice because it doesn't require extra div tags, but it also doesn't retain the style across all browsers. -->
				  <option value=''>Select Date</option>
				  <option value='122222'>Thursday, 12 Aug., YYYY</option><!-- Get last two days' date and display for student  -->
				  
				</select>
				<textarea placeholder="Day's Activity Here" id="txtActivity" name="txtActivity" tabindex="2"></textarea>
			
				
				<textarea placeholder="Day's Comment Here" id="txtComment" name="txtComment" tabindex="3" ></textarea>
      ...
      <div id="apDiv65"  style="border:1px #666666 solid;">
		...
		<div class='container'>
			...
			<div class='subTitle'>Welcome <?php print($_SESSION['firstName'] . " ".$_SESSION['lastName']);  ?></div><a href='../changePassword.php'><div class='menuButton'>Change Password</div></a>
