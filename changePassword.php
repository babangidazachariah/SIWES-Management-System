<?php
SESSION_START();
	if(!empty($_SESSION['matricNumber']) || !empty($_SESSION['schoolStaffID']) || !empty($_SESSION['schoolAdmiID']) || !empty($_SESSION['itfAdminID']) || !empty($_SESSION['itfStaffID']) || !empty($_SESSION['industryStaffID']) ||  !empty($_SESSION['industryAdminID']))
	{
		$errorMessage = "";
		$isError = true;
		$hashPass ="";
		if(isset($_POST['btnSubmitButton'])){
			...
			if(empty($_POST['txtPreviousPassword']))
			{
				$isError = true;
			}
			...
			if (!($isError))
			{
				$hashPass = password_hash( $_POST['txtNewPassword'], PASSWORD_DEFAULT);
				
				if(!empty($_SESSION['matricNumber']))
				{
					//STUDENTS PASSWORD UDATE
					
					
					require_once 'connection.php';
					$sql = "UPDATE tblStudents SET  studentPassword='".$hashPass ."' WHERE studentMatricNumber='". $_SESSION['matricNumber'] ."'";
				...
				}elseif(!empty($_SESSION['itfAdminID']))
				{
					//ITF Admin PASSWORD UDATE
					require_once 'connection.php';
					$sql = "UPDATE tblStudents SET  studentPassword='". $hashPass ."' WHERE studentMatricNumber='". $_SESSION['matricNumber'] ."'";
					mysqli_query($con, $sql) or die(mysqli_error($con));
				...
				}elseif(!empty($_SESSION['itfStaffID']))
				{
					//ITF Staff PASSWORD UDATE
					require_once 'connection.php';
					$sql = "UPDATE tblStaff SET  staffPassword='". $hashPass ."' WHERE staffEmail='". $_SESSION['itfStaffID'] ."'";
					mysqli_query($con, $sql) or die(mysqli_error($con));
				...
				}elseif(!empty($_SESSION['schoolStaffID']))
				{
					//School Staff PASSWORD UDATE
					require_once 'connection.php';
					$sql = "UPDATE tblSchoolStaff SET  schoolStaffPassword='". $hashPass ."' WHERE schoolStaffEmail='". $_SESSION['schoolStaffID'] ."'";
					mysqli_query($con, $sql) or die(mysqli_error($con));
				...
				}elseif(!empty($_SESSION['schoolAdminID']))
				{
					//School Admin PASSWORD UDATE
					require_once 'connection.php';
					$sql = "UPDATE tblSchools SET  schoolPassword='". $hashPass ."' WHERE schoolEmail='". $_SESSION['schoolAdminID'] ."'";
					mysqli_query($con, $sql) or die(mysqli_error($con));
				...
				}elseif(!empty($_SESSION['industryStaffID']))
				{
					//Industry Staff PASSWORD UDATE
					require_once 'connection.php';
					$sql = "UPDATE tblIndustryStaff SET  industryStaffPassword='". $hashPass ."' WHERE industryStaffEmail='". $_SESSION['industryStaffID'] ."'";
					mysqli_query($con, $sql) or die(mysqli_error($con));
				...
				}elseif(!empty($_SESSION['industryAdminID']))
				{
					//Industry Admin PASSWORD UDATE
					require_once 'connection.php';
					$sql = "UPDATE tblIndustries SET  industryPassword='". $hashPass ."' WHERE industryEmail='". $_SESSION['industryAdminID'] ."'";
					mysqli_query($con, $sql) or die(mysqli_error($con));
...
<script type='text/Javascript'>
	...
	function ValidateSubmission()
	{
		var errorMessage = "";
		//alert("hi");
		if((document.getElementById('txtPrevious').value == '') ) {
			
			errorMessage = "Type Current Passwword!!!";
			...
			errorMessage = "Retype New Password!!!";
		}
    ...
    <div id="apDiv36">
      ...
      <div id="apDiv63">
		...
		<div class='shortContainer'>
			...
			<form id="changePassword" name='changePassword' class="form" onclick='return ValidateSubmission();' action="changePassword.php" method="POST">
				<label id='error' class='error'><?php print($errorMessage); ?></label>
				
				<input type="password" placeholder="Current Password Here" id="txtPrevious" name="txtPrevious" tabindex="1"/>
			
				<input type="password" placeholder="New Password Here" id="txtNewPassword" name="txtNewPassword" tabindex="2"/>
				<input type="password" placeholder="Retype New Password Here" id="txtConfirmPassword" name="txtConfirmPassword" tabindex="3"/>	
      ...
      <div id="apDiv65"  style="border:1px #666666 solid;">
		...
		<div class='container'>
			<?php
				...
				if(!empty($_SESSION['matricNumber']) && (strcmp($_SESSION['itfStaffRole'],"Admin") != 0))
				{
					print("<div class='title'>Student Dashboard</div>
			
						<div class='subTitle'>Welcome ".$_SESSION['itfStaffName']."</div>
						<a href='changePassword.php'><div class='menuButton'>Change Password</div></a>
						<a href='bankAccountDetails.php'><div class='menuButton'>Bank Account Details</div></a>
						<a href='bankAccountDetails.php'><div class='menuButton'>Daily SIWES Report</div></a>
						<a href='siwesHome.php?action=logout'><div class='menuButton'>Logout</div></a>");
				}elseif((strcmp($_SESSION['itfStaffRole'],"Admin") == 0) && empty($_SESSION['matricNumber']))
				{
					
					print("<div class='title'>Admin. Dashboard</div>
						<div class='subTitle'>Welcome ".$_SESSION['itfStaffName']."</div>
						<a href='changePassword.php'><div class='menuButton'>Change Password</div></a>
						<a href='itf/addNewAdminStaff.php'><div class='menuButton'>Add New Admin/Staff</div></a>
						<a href='itf/viewEditStaffAdmin.php'><div class='menuButton'>View/Edit Admin/Staff</div></a>
						<a href='itf/instutionsApplication.php'><div class='menuButton'>Institutions Applications</div></a>
						<a href='itf/viewInsttionsApplication.php'><div class='menuButton'>View/Edit Institutions Institutions</div></a>
						
						<a href='itf/industriesApplication.php'><div class='menuButton'>Industries Applications</div></a>
						<a href='itf/viewEditIndustries.php'><div class='menuButton'>View/Edit Existing Industries</div></a>
						
						<a href='itf/addNewBank.php'><div class='menuButton'>Add New Bank</div></a>
						<a href='itf/viewEditBanks.php'><div class='menuButton'>View/Edit Banks Details</div></a>
